...
For given swagger file, answer on user question.
...
REQUEST 1
----------------------------------------------------------------------------------
For given swagger file, generate a request that places a new order for a pet.
```
===
...
### result
- GPT ❌ - Problem too much bloat text around, not directly runnable
...
Act as python coding assistant. 

You'll be given swagger file about api documentation and your goal is to output PYTHON code which is ready to run in runtime. 

!important output just code without any additional information.
...
### result
- GPT ✅ - working, added system prompt adjusted the weight of instructions to output just code without bloat text


![prompt4](./answer_4.png "prompt4")
...
### result
- GPT ✅ - Only ont output with function call in json
- Llama ✅ - Correct but too much bloat text around, wouldn't be usable in tech. implementation 


![prompt5](./answer_5.png "prompt5")

## adjusted prompt 

### system prompt

Make sure to output JSON code only without any additional bloat text around if there's a function call
